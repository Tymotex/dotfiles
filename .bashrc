...
export PATH="$HOME/android-studio-2020.3.1.22-linux/android-studio/bin:$PATH"
alias open=nautilus
...
alias hp='cd ~/Hack/Python/leetcode && code . && exit'
alias hc='cd ~/Hack/C++/leetcode && code . && exit'
alias c='cd ~/Hack/Python/ctci && code . && exit'
...
export PS1="\[\e[01;34m\] Tym \[\e[m\]\[\e[01;32m\]\w\[\e[m\] ➤ "
