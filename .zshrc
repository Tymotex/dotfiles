...
# ===== Aliases =====
alias open='nautilus'
alias timz='cd ~/Projects/timz.dev && code . && exit'
...
alias ctf='cd ~/ctf && code . && exit'
alias size=~/Scripts/size
alias nand2tetris='cd ~/Nand2Tetris && code . && exit'
alias clipboard='xclip -selection c'
alias pdf='xdg-open'
alias math='cd ~/Projects/math-website && code . && exit'
...
alias p2='code ~/Projects/2* && exit'
alias p3='code ~/Projects/3* && exit'
alias p4='code ~/Projects/4* && exit'
alias p5='code ~/Projects/5* && exit'
alias p6='code ~/Projects/6* && exit'
alias p7='code ~/Projects/7* && exit'
